...
// ASCII ART...
	// PISTOL DESIGN...
	const std::string pistolDesignPart01 =  " ___|______   \n";
	const std::string pistolDesignPart02 = " \\_________|= \n";
	...
	const std::string rocketLauncherDesignPart02 =  " _______|     |______  \n";
	const std::string rocketLauncherDesignPart03 = " \\      |     |      | \n";
	const std::string rocketLauncherDesignPart04 = "  \\_____|     |______| \n";
	...
	const std::string swordDesignPart07 =  " ___|  |___ \n";
	const std::string swordDesignPart08 = " \\__|__|__/ \n";
	const std::string swordDesignPart09 =  "     ||     \n";
	const std::string swordDesignPart10 =  "     ||     \n";
	const std::string swordDesignPart11 =  "     ()     \n";
	...
	const std::string swordDesign = (	swordDesignPart01 + swordDesignPart02 + swordDesignPart03 +
										...
										swordDesignPart10 + swordDesignPart11	);
